...
Public Class frmCompany
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con.Open()
            Dim ct As String = "select count(*) from company Having count(*) >= 10"
            ...
            Dim sql As String = ("SELECT top 1 CompanyGroupId FROM dbo.Registration where Name ='Systems Admin'")
            ...
            Else
                companygroupid = cmd.ExecuteScalar
            End If
            con.Close()

            con = New SqlConnection(cs)
            con.Open()
            Dim cb As String = "insert into company(companyName, Address, ContactNo, EmailID, TIN, STNo, CIN, Logo,CompanyGroupId) VALUES (@d1,@d2,@d3,@d4,@d5,@d6,@d7,@d8,@d9)"
            ...
            cmd.Parameters.AddWithValue("@d9", companygroupid)
    ...
    Public Sub Getdata()
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(ID), RTRIM(companyName), RTRIM(Address), RTRIM(ContactNo), RTRIM(EmailID), RTRIM(TIN), RTRIM(STNo), RTRIM(CIN), Logo,CompanyGroupId from company", con)
