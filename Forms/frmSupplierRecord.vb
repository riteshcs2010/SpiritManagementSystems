...
Public Class frmSupplierRecord
        ...
        Try
            If dgw.Rows.Count > 0 Then
                ...
                If lblSet.Text = "Purchase" Then
                    ...
                    lblSet.Text = ""
                End If
                If lblSet.Text = "Supplier Ledger" Then
                    frmSupplierLedger.Show()
                    Me.Hide()
                    frmSupplierLedger.txtSupplierID.Text = dr.Cells(1).Value.ToString()
                    frmSupplierLedger.txtSupplierName.Text = dr.Cells(2).Value.ToString()
                    lblSet.Text = ""
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub btnClose_Click_2(sender As System.Object, e As System.EventArgs)
        Me.Close()
    End Sub
