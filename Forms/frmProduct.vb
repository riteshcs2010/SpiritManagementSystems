...
Public Class frmProduct
    ...
    Sub Reset()
        ...
        cmbSalesUnit.DropDownStyle = ComboBoxStyle.DropDownList
        cmbPurchaseUnit.DropDownStyle = ComboBoxStyle.DropDownList
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cb As String = "Update Product set Productname=@d2, SubCategoryID=@d3, Description=@d4, CostPrice=@d5, SellingPrice=@d6, Discount=@d7, VAT=@d8, ReorderPoint=@d9,ProductCode=@d1,Barcode=@d10,OpeningStock=@d11,PurchaseUnit=@d12,SalesUnit=@d13 where PID=" & txtID.Text & ""
            cmd = New SqlCommand(cb)
            cmd.Parameters.AddWithValue("@d2", txtProductName.Text)
