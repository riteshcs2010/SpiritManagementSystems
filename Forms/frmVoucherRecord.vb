...
Public Class frmVoucherRecord
    ...
    Public Sub GetData()
        Try
            ...
            cmd = New SqlCommand("select v.VoucherNo,v.Name,v.Date,V.Details,v.GrandTotal,vo.Particulars,vo.Amount,vo.Note  from dbo.Voucher v left outer join  dbo.Voucher_OtherDetails vo on v.Id=vo.VoucherID", con)
